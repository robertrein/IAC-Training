    ...
    BEGIN
    {
        ...
        $ScriptBlock = 
        {
            ...
            try
            {
			    ...
			    $OutVar=$diskprops.computername + "|" + $diskprops.disk + "|" + $diskprops.model + "|" `
				+ $diskprops.partition + "|" + $diskprops.description + "|" + $diskprops.primarypartition + "|" `
				+ $diskprops.volumename + "|" + $diskprops.drive + "|" + $diskprops.disksize + "|" `
				+ $diskprops.freespace + "|" + $diskprops.usedspace + "|" + $diskprops.percentfree + "|" `
				+ $diskprops.percentused + "|" + $diskprops.disktype + "|" + $diskprops.serialnumber
			    $outvar
                        }
                    }
                }
